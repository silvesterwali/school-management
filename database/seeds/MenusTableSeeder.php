...
class MenusTableSeeder extends Seeder
{
    ...
    private $siswaRole  = null;
    private $guruRole   = null;
    ...
    public function run()
    {
        ...
        $this->guruRole  = Role::where('name', '=', 'guru')->first();
        // $this->waliRole = Role::where('name', '=', 'walikelas')->first();
        ...
        $this->insertLink('guest,user,admin,guru,siswa', 'Dashboard', '/', 'cil-home');

        //untuk admin
        $id = $this->beginDropdown('admin', 'Data Master Admin', 'cil-fridge');
        $id = $this->insertLink('admin', 'Guru-Staff', '/guru');
        $id = $this->insertLink('admin', 'Siswa', '/siswa');
        $id = $this->insertLink('admin', 'Mapel', '/mapel');
        $id = $this->insertLink('admin', 'Tahun Ajaran', '/ta');
        $id = $this->insertLink('admin', 'Kelas ', '/kelas');
        $id = $this->insertLink('admin', 'Data Diri', '/guru_data_diri');
        $this->endDropdown();

        //untuk guru
        $id = $this->beginDropdown('guru', 'GURU', 'cil-door');
        $id = $this->insertLink('guru', 'List Kelas Guru', '/guru_kelas_siswa');
        $id = $this->insertLink('guru', 'Data Diri', '/guru_data_diri');
        $this->endDropdown();

        //untuk siswa
        $id = $this->beginDropdown('siswa', 'SISWA ', 'cil-door');
        $id = $this->insertLink('siswa', 'Data Kelas Siswa', '/siswa_kelas_akses');
        $id = $this->insertLink('siswa', 'Data Diri', '/data_diri_siswa');
        $id = $this->insertLink('siswa', 'Print Mandiri', '/siswa_kelas_print');
        $this->endDropdown();
...
//php artisan db:seed --class=MenusTableSeeder untuk menjalankan
