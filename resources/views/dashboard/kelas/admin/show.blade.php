                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5>
                            ...
                            {{ $kls->teacher->nama }}</h5>
                        <h6>
                            Tahun Ajaran : {{ $kls->school_year->tahunajaran }}
                        </h6>
                        <a
                    ...
                    <div class="card-body p-1">
                        ...
                        <nav class="p-0" >
                            <div class="nav nav-tabs   nav-justified " id="nav-tab" role="tablist">
                                <a class="nav-item  nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Siswa</a>
                                <a class="nav-item  nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">Mata Pelajaran</a>
                                <a class="nav-item  nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false">Nilai Siswa</a>
                                <a class="nav-item  nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-absesi" role="tab" aria-controls="nav-contact" aria-selected="false">Absensi</a>
                                <a class="nav-item  nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-extrakurikuler" role="tab" aria-controls="nav-contact" aria-selected="false">Extrakurikuler</a>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a class="dropdown-item"
                                        href="{{ Route('KelasSiswa.create',$kls->id) }}">
                                        Tambah Murid</a>
                                    <a class="dropdown-item" href="{{  route('KelasMapel.create',$kls->id) }}">Tambah Mata Pelajaran</a>
                            ...
                            <table class="table table-hover table-sm  display table-bordered "  style="font-size:12px ;widht:100%" id="AdminTableStudent">
                                <thead class="bg-dark">
                                <tr>
                                <th>NISN</th>
                                <th>NAMA</th>
                            ...
                            <div class="tab-pane fade" id="nav-absesi" role="tabpanel" aria-labelledby="nav-absensi-tab">
                                <!-- untuk menambahkan absensi siswa/siswi -->
                                @include('dashboard.kelas.admin.absensi')
                            </div>


                            <div class="tab-pane fade" id="nav-extrakurikuler" role="tabpanel" aria-labelledby="nav-absensi-tab">
                                <!-- untuk menambahkan absensi siswa/siswi -->
