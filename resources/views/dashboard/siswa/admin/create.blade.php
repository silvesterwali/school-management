            ...
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-users"></i>{{ __('Menambah Siswa/i') }}
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('nisn') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nisn" id="input-name"
                                            ...
                                            placeholder="{{ __('NISN') }}" value="{{ old('nisn') }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('nisn') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama"
                                            ...
                                            placeholder="{{ __('Nama') }}" value="{{ old('nama') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check  form-check-radio">
                                            <label class="form-check-label">
                                                <input name="jk"
                                                    ...
                                                    type="radio" value="1" {{ old('jk') == 1 ? 'checked' : ''}}>
                                                Laki-laki
                                        ...
                                        <div class="form-check  form-check-radio">
                                            <label class="form-check-label">
                                                <input name="jk"
                                                    class="form-check-input {{ $errors->has('jk') ? ' is-invalid' : '' }}"
                                                    type="radio" value="0" {{ old('jk') == 0 ? 'checked' : ''}}>
                                                Perempuan
                                                <span class="form-check-sign">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('tanggal_lahir') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="date" name="tanggal_lahir"
                                            ...
                                            placeholder="{{ __('Tanggal lahir') }}" value="{{ old('tanggal_lahir') }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('agama') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="agama"
                                            ...
                                            placeholder="{{ __('Agama') }}" value="{{ old('agama') }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('nama_ibu') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="nama_ibu"
                                            ...
                                            placeholder="{{ __('Nama Ibur') }}" value="{{ old('nama_ibu') }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('wali') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" name="wali"
                                            ...
                                            placeholder="{{ __('Nama Wali') }}" value="{{ old('wali') }}">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                        <label class="form-control-label"
                                            for="input-name">{{ __('Email/Kode Akses ') }}</label>
                                        <input type="text" name="kode_akses"
                                            class="form-control form-control-alternative{{ $errors->has('kode_akses') ? ' is-invalid' : '' }}"
                                            placeholder="{{ __('Email/Kode akses') }}" value="{{ old('kode_akses') }}">
                                ...
                                <div class="col-sm-3">
                                    <div
                                        ...
                                        <label class="form-control-label"
                                            for="input-name">{{ __('Konfirmasi Password') }}</label>
