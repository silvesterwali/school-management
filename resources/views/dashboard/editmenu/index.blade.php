                ...
                @foreach($menuToEdit as $menuel)
                    @if($menuel['slug'] === 'link')
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" href="{{ route('menu.up', ['id' => $menuel['id']]) }}">
                                    <i class="cil-arrow-thick-top"></i>
                                </a>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-success" href="{{ route('menu.down', ['id' => $menuel['id']]) }}">
                                    <i class="cil-arrow-thick-bottom"></i>
                                </a>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-primary" href="{{ route('menu.show', ['id' => $menuel['id']]) }}">Show</a>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-primary" href="{{ route('menu.edit', ['id' => $menuel['id']]) }}">Edit</a>
                            </td>
                            <td>
                                <a class="btn btn-sm btn-danger" href="{{ route('menu.delete', ['id' => $menuel['id']]) }}">Delete</a>
                            </td>
                        </tr>
