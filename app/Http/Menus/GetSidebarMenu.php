...
class GetSidebarMenu implements MenuInterface
{
    ...
    private function getGuruMenu($menuId)
    {
        $this->getMenuFromDB($menuId, 'guru');
    }

    private function getSiswaMenu($menuId)
    {
        $this->getMenuFromDB($menuId, 'siswa');
    }

    public function get($role, $menuId = 4)
    {
    ...
    public function getAll($menuId = 4)
    {
